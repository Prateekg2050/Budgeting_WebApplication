  ...
  return (
    <>
      ...
      >
        ...
        {/* <div id="part2" className="flex mt-5">
          <hr className="mt-5 w-1/2 border-gray-400 h-2" />
          <label className=" self-center mx-2 text-gray-400">or</label>
          <hr className="mt-5 w-1/2 border-gray-400 h-2" />
        </div> */}
        {/* <div
          id="otheroption"
          className="flex justify-between md:justify-evenly"
        >
          <button className=" ">
            <img
              className="hover:-translate-y-2 hover:scale-110"
              src={window.location.origin + "/assets/fb.png"}
              alt=""
            />
          </button>
          <button>
            <img
              className="hover:-translate-y-2 hover:scale-110 "
              src={window.location.origin + "/assets/google.png"}
              alt=""
            />
          </button>
        </div> */}
